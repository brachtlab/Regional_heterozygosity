...
univeralHandle=open('reference_combined_depth_results2.txt','a')
coordDict={}
summed_depth=0
...
print 'omega summed coverage %s summed len %s regional regional_depth %s'%(summed_depth,summed_regional_len,formatted_regional_depth)
